                    ...
                    <table id="alternative-page-datatable" class="table table-striped dt-responsive nowrap w-100">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @else
                                    <span class="badge bg-info">not client</span>
                                @endif
                            </td>
                            <td>
                                <a href="{{route('client.edit', ['id' => $data->id])}}" class="btn btn-success btn-sm" title="Edit">
                                ...
                                <form action="{{route('client.delete', ['id' => $data->id])}}" method="POST" id="privacyDeleteForm{{$data->id}}">
                                    @csrf
                                </form>
                                <script>
