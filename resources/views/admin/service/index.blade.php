    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">New Service Crate</h4>
            </div>
        </div>
    </div>
    <div class="row">
                        ...
                        <div class="tab-pane show active" id="basic-form-preview">
                            <form action="{{route('service.new')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-9">
                                        <input type="text" class="form-control" name="name" id="inputEmail34" placeholder="Service name"/>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputEmail34" class="col-3 col-form-label">Image size: 45 X 45</label>
                                    <div class="col-9">
                                        <input type="file" class="form-control" name="image" multiple id="inputEmail34" placeholder=" Image"/>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    <label for="inputEmail3" class="col-2 col-form-label">Status Service</label>
                                    <div class="col-10">
