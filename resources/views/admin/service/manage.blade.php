                    ...
                    <table id="alternative-page-datatable" class="table table-striped dt-responsive nowrap w-100">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @else
                                    <span class="badge bg-info">not Service</span>
                                @endif
                            </td>
                            <td>
                                <a href="{{route('service.edit', ['id' => $data->id])}}" class="btn btn-success btn-sm" title="Edit">
                                ...
                                <form action="{{route('service.delete', ['id' => $data->id])}}" method="POST" id="privacyDeleteForm{{$data->id}}">
                                    @csrf
                                </form>
                                <script>
