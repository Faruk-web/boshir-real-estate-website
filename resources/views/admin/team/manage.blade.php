    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Support Team Manage</h4>
            </div>
        </div>
    </div>
    <!-- end row -->
                ...
                <div class="card-body">
                    <table id="alternative-page-datatable" class="table table-striped dt-responsive nowrap w-100">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{route('team.edit', ['id' => $data->id])}}" class="btn btn-success btn-sm" title="Edit">
                                ...
                                <form action="{{route('team.delete', ['id' => $data->id])}}" method="POST" id="privacyDeleteForm{{$data->id}}">
                                    @csrf
                                </form>
                                <script>
